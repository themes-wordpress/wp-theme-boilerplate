...
class Search extends _Base__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(...options) {
    super();
  ...
  static openBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger");
  static closeBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay__close");
  static overlay = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay");
  static searchTerm = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term");
  static body = jquery__WEBPACK_IMPORTED_MODULE_0___default()("body");
  static results = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results");
  static spinner = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results");
  init() {
    this.typingTimer;
  ...
  searchTerm() {
    ...
    searchTerm.on({
      keydown: function (e) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(postUrl, function (posts) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkwpuniversity"] = globalThis["webpackChunkwpuniversity"] || [];
